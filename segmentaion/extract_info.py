    ...
    def extract(cls,post):
        ...
        for line in post_list:
            ...
            if True:
                ...
                if cls.segment['year'] == '-' and re.search(year_reg, line):
                ...
                if (cls.segment['grade'] == '-') and (re.search(grade_reg, line)):
                    try:
                ...
                if cls.segment['color'] == '-' and re.search(color_reg, line):
                    cls.segment['color'] = re.search(color_reg, line).group()

                if (cls.segment['body_type'] == '-') and (re.search(body_reg,line)):
                    cls.segment['body_type'] = re.search(body_reg, line).group()

                if (cls.segment['wheel_drive'] == '-') and (re.search(drive_reg,line)):
                    try:
                ...
                if cls.segment['fuel'] == '-' and re.search(fuel_reg,line):
                ...
                if cls.segment['engine'] == '-' and re.search(engine_reg, line):
                ...
                if cls.segment['price'] == '-' and re.search(price_reg, line):
                    try:
                ...
                if cls.segment['mileage'] == '-' and re.search(mileage_reg, line):
                ...
                if (cls.segment['region'] == '-') and (re.search(region_reg,line)):
                    try:
                ...
                if (cls.segment['gear'] == '-') and (re.search(drive_reg, line)):
                    if ( line.find('auto') > 0 ):
                ...
                if (cls.segment['seater'] == '-') and (re.search(seater_reg, line)):
                    try:
                        cls.segment['seater'] = re.findall(r'\d',line)[0] + ' seats'
                    except:
                        cls.segment['seater'] = '-'
                        
                if (cls.segment['hand_drive'] == '-') and (re.search(hand_reg,line)):
                ...
                if cls.segment['license'] == '-' and (re.search(license_reg,line)):
