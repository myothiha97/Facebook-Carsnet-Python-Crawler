    ...
    for line in post_list:
        ...
        if (len(line) > 120):
            ...
            if (segment['hand_drive'] == '-') and (re.search(hand_reg,line)):
                drive_position = re.search(hand_reg,line).group()
                
                if drive_position == 'ဘယ်မောင်း' or drive_position == "l.h.d" or drive_position == "lhd":
                    segment['hand_drive'] = 'L.H.D'
                if drive_position == 'ညာမောင်း' or drive_position == "r.h.d" or drive_position == "rhd":
