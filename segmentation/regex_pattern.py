...
license_reg   = r"\d[A-Za-z]\s*\-\s*\d{4}|\d[A-Z]\s*[/]\s*\d{4}|\d[a-z]\s*[/]\s*\d{4}|\d[a-z]\s*[-/ ]\s*(ygn|mdy|shn|sgg|bgo|npw|ayy|rke|kyn|chn)|\d[A-Za-z]\s*[-/ ]*\s*\([A-Za-z]+\)|\d[A-Za-z]\s*[-/ ]\s*[*]+|license|licence|လိုင်စင်"
