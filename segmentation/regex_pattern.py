...
price_reg = r'သိန်း\s*[၀-၉]+|[၀-၉]+\s*သိန်း|\$\s*\d+\,\d+|\d+\s*သိန်း|သိန်း\s*\d+|\d+\s*lakhs|lakhs\s*\d+|စျေး\s*\=*\s*\d+|စျေး\s*\=*\s*[၀-၉]+|စျေး\s*\-*\s*\d+|စျေး\s*\-*\s*[၀-၉]+|\d+\s*lhks|lhks\s*\d+|ဈေးနူန်း\s*\=*\s*[၀-၉]+|ဈေးနူန်း\s*\=*\s*\d+|ဈေးနူန်း\s*\-*\s*[၀-၉]+|ဈေးနူန်း\s*\-*\s*\d+|စျေးနှုန်း\s*[-= ]*\s*\d+|\d+\s*lks|lks\s*\d+|သိိန်း|price|lakhs|lks|စျေး|သိန်း'
...
if __name__ == "__main__":
    ...
    if re.search(price_reg,'၁၉၅ သိိန်း ဖြင့်ရောင်းချပေးပါမည်။'):
        print('pattern found')
